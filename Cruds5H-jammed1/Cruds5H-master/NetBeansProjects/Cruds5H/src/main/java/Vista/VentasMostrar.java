...
import controlador.VentasMostrarControlador;
import java.sql.Connection;
import modelo.conexion;

public class VentasMostrar extends javax.swing.JFrame {


    public VentasMostrar() {
        initComponents();
    try {
        Connection con = conexion.getInstancia().getConexion();
        new VentasMostrarControlador(this, con);
    } catch (Exception e) {
        e.printStackTrace();
    }
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentasMostrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentasMostrar().setVisible(true);
            }
        });
    }

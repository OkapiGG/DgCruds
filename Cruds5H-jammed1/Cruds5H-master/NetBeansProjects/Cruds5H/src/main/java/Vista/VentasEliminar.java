...
import controlador.VentasEliminarControlador;
import java.sql.Connection;
import modelo.conexion;

public class VentasEliminar extends javax.swing.JFrame {

    public VentasEliminar() {
        initComponents();
    try {
        Connection con = conexion.getInstancia().getConexion();
        new VentasEliminarControlador(this, con);
    } catch (Exception e) {
        e.printStackTrace();
   }
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentasEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentasEliminar().setVisible(true);
            }
        });
    }

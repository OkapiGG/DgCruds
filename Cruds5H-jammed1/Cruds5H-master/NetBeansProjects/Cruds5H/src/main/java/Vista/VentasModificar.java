...
import controlador.VentasModificarControlador;
import java.sql.Connection;
import modelo.conexion;

public class VentasModificar extends javax.swing.JFrame {

    public VentasModificar() {
        initComponents();
    try {
        Connection con = conexion.getInstancia().getConexion();
        new VentasModificarControlador(this, con);
    } catch (Exception e) {
        e.printStackTrace();
   }
}
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modificar Ventas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentasModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentasModificar().setVisible(true);
            }
        });
    }

...
import controlador.ProveedorMostrarCon;
 ...
 * @author ep712
 */
public class ProveedorMostrar extends javax.swing.JFrame {

    /**
     * Creates new form ProveedorMostrar
     */
    public ProveedorMostrar() {
        initComponents();
          try {
            Connection con = conexion.getInstancia().getConexion();
            new ProveedorMostrarCon(this, con);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProveedorMostrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProveedorMostrar().setVisible(true);
            }
        });
    }
